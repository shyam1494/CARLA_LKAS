...
# File modified by Luca Venturi for Packt Publishing, to record 3 video streams at the same time
...
class KeyboardControl(object):
    ...
    def parse_events(self, client, world, clock):
        ...
        if not self._autopilot_enabled:
            ...
            world.camera_manager.set_last_controls(self._control)
...
class CameraManager(object):
    ...
    def set_sensor(self, index, notify=True, force_respawn=False):
        ...
        camera_name = self.get_camera_name(index)
        ...
        if needs_respawn:
            ...
            # circular reference.
            weak_self = weakref.ref(self)
            self.sensor.listen(lambda image: CameraManager._parse_image(weak_self, image, camera_name))
        if notify:
    ...
    def _parse_image(weak_self, image, camera_name):
        ...
        CameraManager._save_image(weak_self, image, camera_name)
